...
<head>
    ...
    <title>Jaringan Tanpa Nama</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="/billgates"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                {{ __('Sign in to view billing statements and see who has paid.') }}
                            </p>
                        </div>
                    ...
                    {{-- <a href="/register"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                {{ __('Register to subscribe to our internet, and enjoy the best facilities we provide.') }}
                            </p>
                        </div>
                    ...
                    <a href="{{ url('http://49.0.2.107/') }}" target="blank"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                {{ __('Mikrotik Hotspot Monitoring.') }}
                            </p>
                        </div>
                    ...
                    <a href="http://jtn.as.net.id/phpmyadmin" target="blank"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                {{ __('See the data of anyone who has been recorded.') }}
                            </p>
                        </div>
                    ...
                    <a href="https://nonamenetwork.blogspot.com" target="blank"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                {{ __('We will tell you tutorials and information about networking for free.') }}
                            </p>
                        </div>
